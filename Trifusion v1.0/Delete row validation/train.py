from delete_row_expriment import *
from model import *
import warnings
from param import *
...
def train(args):
    ...
    for i in range(args.kfolds):
        ...
        for epoch in range(args.epoch):
            ...
            test_auc, metric_result, y_true, y_score = valid(args, model,similarity_feature,
                                                             g, edge_idx_dict,
                                                             edge_idx_dict[str(i)]['fold_valid_edges_20p_20n'], i)
